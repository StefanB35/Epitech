...
if __name__ == "__main__":
    p = argparse.ArgumentParser(description="Clean predi_doses_2025.csv")
    p.add_argument("--input", "-i", type=Path, default=Path("Hackathon/Data/predi_doses_2025.csv"))
    p.add_argument("--output", "-o", type=Path, default=Path("Hackathon/Data_Clean/predi_doses_2025_cleaned.csv"))
    args = p.parse_args()
